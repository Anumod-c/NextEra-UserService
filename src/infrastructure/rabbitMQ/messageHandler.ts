  ...
  static async handle(
    ...
    switch (operations) {
      ...
      case "forgot_pass_otp": // Add this case for forgot password OTP
        ...
        console.log(
          "data(OTP) for forgot password reached inside the message handler",
          response
        );
        break;
      case "user_reset_pass":
        ...
        console.log(
          "data(RESETPASSWORD) for reset password reached inside the message handler",
          response
        );
        break;
      case "google_login":
      ...
      case "forgot_pass_resend_otp":
        console.log(
          "data reached indside the forgot pass resent otp",
          operations,
          data
        );
